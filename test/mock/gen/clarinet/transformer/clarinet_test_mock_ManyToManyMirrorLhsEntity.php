 ...
 */
class clarinet_test_mock_ManyToManyMirrorLhsEntity {

  public function asArray(\clarinet\test\mock\ManyToManyMirrorLhsEntity $model) {
    $a = Array();
  ...
  public function fromArray(Array $a) {
    $model = new \clarinet\test\mock\ManyToManyMirrorLhsEntity();
