...
*/
class zpt_orm_test_mock_ManyToManyMirrorRhsEntity {
  ...
  */
  public function asArray(\zpt\orm\test\mock\ManyToManyMirrorRhsEntity $model = null) {
    ...
    if ($relVal === null) {
      ...
      $transformer = Transformer::get('zpt\orm\test\mock\ManyToManyMirrorLhsEntity');
      $rels = array();
  ...
  */
  public function asCollection(array $models) {
    ...
    foreach ($models AS $model) {
      if (!($model instanceof \zpt\orm\test\mock\ManyToManyMirrorRhsEntity)) {
  ...
  public function fromArray(array $a, $model = null, array $whiteList = null) {
    if ($model === null) {
      if (isset($a['id'])) {
        ...
        $model = new \zpt\orm\test\mock\ManyToManyMirrorRhsEntity();
      }
    }
