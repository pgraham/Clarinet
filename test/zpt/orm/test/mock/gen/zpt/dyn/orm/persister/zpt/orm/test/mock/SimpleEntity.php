...
class zpt_orm_test_mock_SimpleEntity {
  ...
  */
  public function __construct() {
    ...
    $this->deleteSql = "DELETE FROM simple_entity WHERE id = :id";
  ...
  */
  public function count(Criteria $c) {
    ...
    try {
      ...
      $e = new PdoExceptionWrapper($e, 'zpt\orm\test\mock\SimpleEntity');
      $e->setSql($sql, $params);
      throw $e;
    }
  }
  ...
  */
  public function create(\zpt\orm\test\mock\SimpleEntity $model) {
    ...
    try {
      ...
      $transformer = ActorFactory::getActor('transformer', 'zpt\orm\test\mock\SimpleEntity');
  ...
  */
  public function delete(\zpt\orm\test\mock\SimpleEntity $model) {
    $id = $model->getid();
    if ($id === null) {
      throw new Exception("Can't delete zpt\\orm\\test\\mock\\SimpleEntity because it does not have an id");
    }
  ...
  */
  public function getQueryBuilder() {
    return QueryBuilder::get('zpt\orm\test\mock\SimpleEntity');
  }
