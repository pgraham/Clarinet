...
class zpt_orm_test_mock_ManyToOneEntity {
  ...
  */
  public function __construct() {
    ...
    $this->updateSql =
      "UPDATE many_to_one_entity
      SET `name` = :name,`simple_entity_id` = :simple_entity_id
      WHERE id = :id";
    $this->_update = $this->_pdo->prepare($this->updateSql);

    $this->deleteSql = "DELETE FROM many_to_one_entity WHERE id = :id";
  ...
  */
  public function count(Criteria $c) {
    ...
    try {
      ...
      $e = new PdoExceptionWrapper($e, 'zpt\orm\test\mock\ManyToOneEntity');
      $e->setSql($sql, $params);
      throw $e;
    }
  }
  ...
  */
  public function create(\zpt\orm\test\mock\ManyToOneEntity $model) {
    ...
    try {
      ...
      $transformer = ActorFactory::getActor('transformer', 'zpt\orm\test\mock\ManyToOneEntity');
  ...
  */
  public function delete(\zpt\orm\test\mock\ManyToOneEntity $model) {
    $id = $model->getid();
    if ($id === null) {
      throw new Exception("Can't delete zpt\\orm\\test\\mock\\ManyToOneEntity because it does not have an id");
    }
  ...
  */
  public function getQueryBuilder() {
    return QueryBuilder::get('zpt\orm\test\mock\ManyToOneEntity');
  }
    ...
    try {
      ...
      foreach ($stmt AS $row) {
        ...
        if ($relId !== null) {
          ...
          if ($related === null) {
            throw new Exception("No zpt\\orm\\test\\mock\\SimpleEntity with id $relId.");
          }
  ...
  public function update(\zpt\orm\test\mock\ManyToOneEntity $model, $debug = false) {
    ...
    try {
      ...
      if ($rhs !== null) {
        $rhsId = $rhs->getid();
        if ($rhsId === null) {
          $persister = ActorFactory::getActor('persister', 'zpt\orm\test\mock\SimpleEntity');
          $rhsId = $persister->create($rhs);
        }
      }
      $params[':simple_entity_id'] = $rhsId;
