...
class zpt_orm_test_mock_ManyToOneMirrorEntity {
  ...
  */
  public function __construct() {
    ...
    $this->createSql =
      ...
      (`name`,`one_to_many_mirror_id`) VALUES (:name,:one_to_many_mirror_id)";
  ...
  */
  public function delete(\zpt\orm\test\mock\ManyToOneMirrorEntity $model) {
    ...
    try {
      ...
      // ---------------------------------------------------------------------
      // Delete related zpt\orm\test\mock\OneToManyMirrorEntity entities
      // ---------------------------------------------------------------------
  ...
  * @param ${class} $model
  */
  public function update(\zpt\orm\test\mock\ManyToOneMirrorEntity $model) {
    $id = $model->getid();
    if ($id === null) {
