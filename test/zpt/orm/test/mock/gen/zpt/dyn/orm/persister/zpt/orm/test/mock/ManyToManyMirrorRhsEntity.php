...
class zpt_orm_test_mock_ManyToManyMirrorRhsEntity {
  ...
  */
  ...
  /**
  * Create a new persister for zpt\orm\test\mock\ManyToManyMirrorRhsEntity entities.
  */
  ...
  *
  * @param zpt\orm\test\mock\ManyToManyMirrorRhsEntity $model
  */
  ...
  * @param zpt\orm\test\mock\ManyToManyMirrorRhsEntity $model
  */
  public function update(\zpt\orm\test\mock\ManyToManyMirrorRhsEntity $model, $debug = false) {
    $id = $model->getid();
    if ($id === null) {
