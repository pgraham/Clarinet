...
class zpt_orm_test_mock_OneToManyRhs {
  ...
  */
  ...
  /**
  * Create a new persister for zpt\orm\test\mock\OneToManyRhs entities.
  */
  public function __construct() {
    $this->_pdo = PdoWrapper::get();

    $this->createSql =
      "INSERT INTO one_to_many_rhs
      (`name`,`one_to_many_entity_id`)
      VALUES
      (:name,:one_to_many_entity_id)";
    $this->_create = $this->_pdo->prepare($this->createSql);

    $this->updateSql =
      "UPDATE one_to_many_rhs
      SET `name` = :name,`one_to_many_entity_id` = :one_to_many_entity_id
      WHERE id = :id";
    $this->_update = $this->_pdo->prepare($this->updateSql);

    $this->deleteSql = "DELETE FROM one_to_many_rhs WHERE id = :id";
  ...
  */
  public function count(Criteria $c) {
    ...
    try {
      ...
      $e = new PdoExceptionWrapper($e, 'zpt\orm\test\mock\OneToManyRhs');
      $e->setSql($sql, $params);
      throw $e;
    }
  }
  ...
  *
  * @param zpt\orm\test\mock\OneToManyRhs $model
  */
  public function create(\zpt\orm\test\mock\OneToManyRhs $model) {
    $validator = ActorFactory::getActor('validator', 'zpt\orm\test\mock\OneToManyRhs');
    ...
    try {
      ...
      $params[':one_to_many_entity_id'] = $model->getoneToManyEntityId();
      ...
      $transformer = ActorFactory::getActor('transformer', 'zpt\orm\test\mock\OneToManyRhs');
  ...
  * @param zpt\orm\test\mock\OneToManyRhs $model
  */
  public function delete(\zpt\orm\test\mock\OneToManyRhs $model) {
    $id = $model->getid();
    if ($id === null) {
      throw new Exception("Can't delete zpt\\orm\\test\\mock\\OneToManyRhs because it does not have an id");
    }
  ...
  *
  * @param integer $id
  * @return zpt\orm\test\mock\OneToManyRhs
  */
  ...
  */
  public function getQueryBuilder() {
    return QueryBuilder::get('zpt\orm\test\mock\OneToManyRhs');
  }
  ...
  public function retrieve(Criteria $c = null, $debug = false) {
    ...
    try {
      ...
      foreach ($stmt AS $row) {
        ...
        $model->setoneToManyEntityId($row['one_to_many_entity_id']);
  ...
  * @param zpt\orm\test\mock\OneToManyRhs $model
  */
  public function save(\zpt\orm\test\mock\OneToManyRhs $model) {
    $id = $model->getid();
    if ($id === null) {
      $this->create($model);
    } else {
  ...
  * @param zpt\orm\test\mock\OneToManyRhs $model
  */
  public function update(\zpt\orm\test\mock\OneToManyRhs $model, $debug = false) {
    $id = $model->getid();
    if ($id === null) {
      throw new Exception("Can't update zpt\\orm\\test\\mock\\OneToManyRhs because it does not have an id");
    }
