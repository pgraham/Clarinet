...
class zpt_orm_test_mock_ManyToManyMirrorLhsEntity {
  ...
  public function validate(\zpt\orm\test\mock\ManyToManyMirrorLhsEntity $model, &$e = false) {
    ...
    if (count($msgs) > 0) {
      $ex = new ValidationException($msgs, 'zpt\orm\test\mock\ManyToManyMirrorLhsEntity');
      if ($e !== false) {
        $e = $ex;
      } else {
        throw $ex;
