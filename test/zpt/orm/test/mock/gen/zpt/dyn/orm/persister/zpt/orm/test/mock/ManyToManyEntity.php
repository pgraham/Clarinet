...
class zpt_orm_test_mock_ManyToManyEntity {
  ...
  */
  ...
  /**
  * Create a new persister for zpt\orm\test\mock\ManyToManyEntity entities.
  */
  ...
  *
  * @param zpt\orm\test\mock\ManyToManyEntity $model
  */
  ...
  * @param zpt\orm\test\mock\ManyToManyEntity $model
  */
  public function update(\zpt\orm\test\mock\ManyToManyEntity $model, $debug = false) {
    $id = $model->getid();
    if ($id === null) {
