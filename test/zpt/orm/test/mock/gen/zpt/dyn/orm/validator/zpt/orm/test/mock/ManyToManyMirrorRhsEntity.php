...
class zpt_orm_test_mock_ManyToManyMirrorRhsEntity {
  ...
  public function validate(\zpt\orm\test\mock\ManyToManyMirrorRhsEntity $model, &$e = false) {
    ...
    if (count($msgs) > 0) {
      $ex = new ValidationException($msgs, 'zpt\orm\test\mock\ManyToManyMirrorRhsEntity');
      if ($e !== false) {
        $e = $ex;
      } else {
        throw $ex;
