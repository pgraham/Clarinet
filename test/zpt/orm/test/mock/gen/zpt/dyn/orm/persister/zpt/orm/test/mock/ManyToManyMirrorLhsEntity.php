...
class zpt_orm_test_mock_ManyToManyMirrorLhsEntity {
  ...
  */
  public function __construct() {
    ...
    $this->updateSql =
      "UPDATE many_to_many_lhs_entity
      SET `name` = :name
      WHERE id = :id";
    $this->_update = $this->_pdo->prepare($this->updateSql);

    $this->deleteSql = "DELETE FROM many_to_many_lhs_entity WHERE id = :id";
  ...
  */
  public function count(Criteria $c) {
    ...
    try {
      ...
      $e = new PdoExceptionWrapper($e, 'zpt\orm\test\mock\ManyToManyMirrorLhsEntity');
      $e->setSql($sql, $params);
      throw $e;
    }
  }
  ...
  */
  public function create(\zpt\orm\test\mock\ManyToManyMirrorLhsEntity $model) {
    ...
    try {
      ...
      $transformer = ActorFactory::getActor('transformer', 'zpt\orm\test\mock\ManyToManyMirrorLhsEntity');
  ...
  */
  public function delete(\zpt\orm\test\mock\ManyToManyMirrorLhsEntity $model) {
    $id = $model->getid();
    if ($id === null) {
      throw new Exception("Can't delete zpt\\orm\\test\\mock\\ManyToManyMirrorLhsEntity because it does not have an id");
    }
  ...
  */
  public function getQueryBuilder() {
    return QueryBuilder::get('zpt\orm\test\mock\ManyToManyMirrorLhsEntity');
  }
  ...
  public function retrieve(Criteria $c = null) {
    ...
    try {
      ...
      foreach ($stmt AS $row) {
        ...
        // -------------------------------------------------------------------
        // Populate the zpt\orm\test\mock\ManyToManyMirrorRhsEntity
        $c = new Criteria();
        $c->addSelect('many_to_many_rhs_entity.*');
        $c->addInnerJoin('many_to_many_lhs_entity_many_to_many_rhs_entity_link', 'id', 'many_to_many_rhs_entity_id');
