...
class zpt_orm_test_mock_OneToManyMirrorEntity {
  ...
  */
  ...
  /**
  * Create a new persister for zpt\orm\test\mock\OneToManyMirrorEntity entities.
  */
  public function __construct() {
    $this->_pdo = PdoWrapper::get();

    $this->createSql =
      "INSERT INTO one_to_many_mirror
      (`name`)
      VALUES
      (:name)";
    ...
    $this->updateSql =
      "UPDATE one_to_many_mirror
      SET `name` = :name
      WHERE id = :id";
    $this->_update = $this->_pdo->prepare($this->updateSql);

    $this->deleteSql = "DELETE FROM one_to_many_mirror WHERE id = :id";
  ...
  */
  public function count(Criteria $c) {
    ...
    try {
      ...
      $e = new PdoExceptionWrapper($e, 'zpt\orm\test\mock\OneToManyMirrorEntity');
      $e->setSql($sql, $params);
      throw $e;
    }
  }
  ...
  *
  * @param zpt\orm\test\mock\OneToManyMirrorEntity $model
  */
  public function create(\zpt\orm\test\mock\OneToManyMirrorEntity $model) {
    $validator = ActorFactory::getActor('validator', 'zpt\orm\test\mock\OneToManyMirrorEntity');
    ...
    try {
      ...
      $transformer = ActorFactory::getActor('transformer', 'zpt\orm\test\mock\OneToManyMirrorEntity');
      ...
      // ---------------------------------------------------------------------
      // Save related zpt\orm\test\mock\ManyToOneMirrorEntity entities
      ...
      $sql = "UPDATE many_to_one_mirror
              SET one_to_many_mirror_id = :id
              WHERE id = :relId";
  ...
  * @param zpt\orm\test\mock\OneToManyMirrorEntity $model
  */
  public function delete(\zpt\orm\test\mock\OneToManyMirrorEntity $model) {
    $id = $model->getid();
    if ($id === null) {
      throw new Exception("Can't delete zpt\\orm\\test\\mock\\OneToManyMirrorEntity because it does not have an id");
    }
  ...
  *
  * @param integer $id
  * @return zpt\orm\test\mock\OneToManyMirrorEntity
  */
  ...
  */
  public function getQueryBuilder() {
    return QueryBuilder::get('zpt\orm\test\mock\OneToManyMirrorEntity');
  }
  ...
  public function retrieve(Criteria $c = null, $debug = false) {
    ...
    try {
      ...
      foreach ($stmt AS $row) {
        ...
        // -------------------------------------------------------------------
        // Populate the zpt\orm\test\mock\ManyToOneMirrorEntity
        $c = new Criteria();
  ...
  * @param zpt\orm\test\mock\OneToManyMirrorEntity $model
  */
  public function save(\zpt\orm\test\mock\OneToManyMirrorEntity $model) {
    $id = $model->getid();
    if ($id === null) {
      $this->create($model);
    } else {
  ...
  * @param zpt\orm\test\mock\OneToManyMirrorEntity $model
  */
  public function update(\zpt\orm\test\mock\OneToManyMirrorEntity $model, $debug = false) {
    $id = $model->getid();
    if ($id === null) {
      throw new Exception("Can't update zpt\\orm\\test\\mock\\OneToManyMirrorEntity because it does not have an id");
    }
    ...
    try {
      ...
      $sql = "UPDATE many_to_one_mirror SET one_to_many_mirror_id = :id WHERE id = :relId";
      $updateStmt = $this->_pdo->prepare($sql);
      foreach ($related AS $rel) {
        $params = array(
          'id' => $id,
      ...
      $sql = "UPDATE many_to_one_mirror SET one_to_many_mirror_id = null WHERE id = :relId";
